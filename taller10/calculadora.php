...
<body>
    ...
    <form action="" method="POST">
        <div class="form-group">
            ...
            <input type="number" name="n1" class="form-control" id="exampleFormControlInput1" placeholder="Digite número 1" required>
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput2">Número 2:</label>
            <input type="number" name="n2" class="form-control" id="exampleFormControlInput2" placeholder="Digite número 2" required>
        </div>
        <div class="form-group">
