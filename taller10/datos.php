...
<body>
    <a href="index.html#section-respuestas">   
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="search-row">
                    <input type="text" name="search" class="form-control" placeholder="Digite su palabra clave">
                </div>
                </div>
            </div>
            </div>
        ...
        <li><a href="javascript:void(0)" class="next">Siguiente</a></li>
            ...
            <h1 class="titulo">Formulario para agregar datos</h1> <br>
        <form action="back/almacenar_datos.php" method="POST">
            <input type="text" name="nombre" placeholder="Digite el nombre" required>
            <input type="text" name="apellido" placeholder="Digite apellido" required>
            <input type="number" name="cedula" placeholder="Digite la número de cedula" required>
            <input type="submit" name="almacenar" value="Guardar">
        </form>

        <h1 class="titulo">Formulario para actualizar</h1> <br>
